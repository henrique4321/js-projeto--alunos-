...
// ================= ANIMAÇÃO DO TÍTULO =================
// Seleciona o elemento do título e define as variáveis para a animação
...
// Adiciona eventos de clique nos botões de navegação do carrossel
...
function checkAboutVisibility() {
    ...
    if(rect.top <= windowHeight * 0.75 && rect.bottom >= 0) {
        aboutSection.classList.add('visible'); //adiciona a classe
...
//Verifica a visibilidade ao carregar a página (caso a seçao já esteja visível)
